...
int main()
{
    ...
    while(true)
    {
        ...
        colorSet(4);
            gamePart("seperator");
        colorSet(7);
            cout<<"(Press the number of your choide!) ";
        colorSet(15);
        ...
        if(level == 1 ){
             ...
             highlight = (" .F. |F.F. |F.F. " + dot 
              ...
              solution = ("9.8.3|5.2.7|6.4.1" + dot 
                       ...
                       +  "6.4.6|7.8.3|2.5.9" + dot
                       +  "3.7.5|9.5.2|1.6.4" + dot
		...
		cout<<endl;
			...
			if(sudokuStatus == "playing"){
				...
				cout<<"Congratulations you solve"<<endl
					<<" the sudoku puuzzle."<<endl;
				colorSet(13);
				cout<<"Your sudoku skills are"<<endl
					<<" quite impressive!"<<endl<<endl;
				colorSet(7);
				cout<<" [Press any key to exti the game]";
				getch();
				main();
			}
			else{
...
void pauseGame(){
    do{
        ...
        gamePart("seperator");
        colorSet(7);
        cout<<"(Press the numer of your choie!)";
        colorSet(15);
...
void helpSudoku(string located){
    system ("cls");
  		  ...
  		  colorSet(4);
  		    gamePart("line_small_right");
 		   colorSet(13);
 		     cout<<setw(25)<<right<<"INSTRUCTION"<<endl;
 		   colorSet(4);
 		     gamePart("seperator");
 		   colorSet(10);
 		   ...
 		   colorSet(15);
			  cout<<" * The sudoku puzzle is consist of "<<endl
    			  <<"   a 9 x 9 grid,you have to fill"<<endl
  		 		  <<"   number 1 to 9. "<<endl
  		  		  <<" * Use the 1-9 keys in your"<<endl
   		 		  <<"   keyboard to fill the sudoku"<<endl
   				  <<"   puzzle"<<endl
   				  <<" * To move arount the sudoku"<<endl
    		  	...
    		  	<<"   at last me and 4 haggu people made this (suka bylat)(- -)|"<<endl;
		colorSet(4);
    	  gamePart("seperator");
		colorSet(7);
